...
./build/bin/llama-server -hf unsloth/Qwen3-235B-A22B-Instruct-2507-GGUF:Q2_K_XL --host 0.0.0.0 --port 8080   --n-gpu-layers 6  --no-prefill-assistant  --ctx-size 32768 --jinja  -fa -sm row --temp 0.6 --top-k 20 --top-p 0.95 --min-p 0
