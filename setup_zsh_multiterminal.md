...
for p in zsh-autosuggestions zsh-syntax-highlighting zsh-history-substring-search colored-man-pages command-not-found fzf docker docker-compose kubectl terraform node npm gradle mvn flutter sudo jsontools encode64 timer extract; do
